    ...
    <div className="App">
      ...
      <div className="row" style={{ backgroundColor: '#282c34' }}>
        <div className="col-md-6">
          <button className={`btn btn-${view === 'stickers' ? 'primary' : 'secondary'} btn-block`} onClick={() => setView('stickers')}>
            Stickers
          </button>
        </div>
        <div className="col-md-6">
          <button className={`btn btn-${view === 'backgrounds' ? 'primary' : 'secondary'} btn-block`} onClick={() => setView('backgrounds')}>
            Backgrounds
          </button>
        </div>
      </div>
